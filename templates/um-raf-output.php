...
<form id="um-raf-form" class="<?php echo esc_attr( apply_filters( 'um_raf_form_class', 'um-raf-form' ) ); ?>">
	...
	<label for="um-raf-email" class="<?php echo esc_attr( apply_filters( 'um_raf_label_class', 'um-raf-label' ) ); ?>">
		<?php echo esc_html( apply_filters( 'um_raf_email_label', __( 'Email', 'um_raf' ) ) ); ?>:
	</label>
	...
	<button type="submit" class="<?php echo esc_attr( apply_filters( 'um_raf_button_class', 'um-raf-button' ) ); ?>">
		<?php echo esc_html( apply_filters( 'um_raf_button_text', __( 'Resend', 'um_raf' ) ) ); ?>
		<div id="um-raf-loader">
			<div class="<?php echo esc_attr( apply_filters( 'um_raf_loader_class', 'um-raf-loader' ) ); ?>"></div>
		</div>
	</button>
